 ...
 * Documentation: I referenced my DLL code from CS220 to help implement the page queue functions.
 * I also referenced the zyBooks LRU explanation and PEX3 slides in order to understand how to 
 * implement the LRU algorithm for the pqAccess function.
 * =========================================================== */
#include <stdio.h>
#include <stdlib.h>
#include "byutr.h"
